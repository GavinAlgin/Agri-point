...
export default function _layout() {
  return (
    <AuthProvider>
      <Tabs screenOptions={{ tabBarActiveTintColor: '#103713', tabBarShowLabel: false, headerShown: false, tabBarStyle: { backgroundColor: '#fff', borderTopWidth: 0, elevation: 0, padding: width * 0.04, marginBottom: 12,} }}>
